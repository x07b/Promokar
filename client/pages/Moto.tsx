...
export default function Moto() {
  const motoProducts = [
    ...
    },
    {
      ...
      name: "5100 4T 15W50",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Huile moteur 4T semi-synthétique"
    },
    {
      id: "800-2t-road-racing",
      name: "800 2T ROAD RACING",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Huile moteur 2T 100% synthétique"
    },
    {
      id: "gear-80w90",
      name: "GEAR 80W90",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Huile transmission moto"
    },
    {
      id: "fork-oil-medium",
      name: "FORK OIL MEDIUM",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Huile fourche hydraulique"
    },
    {
      id: "motul-brake-fluid-rbf",
      name: "RBF 600",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Liquide de frein racing"
    },
    {
      id: "coolant-motocool-expert",
      name: "MOTOCOOL EXPERT",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Liquide de refroidissement moto"
    },
    {
      id: "engine-clean-moto",
      name: "ENGINE CLEAN MOTO",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant moteur spécial moto"
    }
  ];
      ...
      <section className="relative bg-gray-800 text-white py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl">
            Lubrifiants haute performance pour motos. Huiles 2T, 4T, transmission, 
            freins et produits d'entretien spécialisés.
          </p>
        </div>
      </section>
