...
export default function Entretien() {
  const entretienProducts = [
    ...
    },
    {
      ...
      name: "RADIATOR CLEAN",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant circuit de refroidissement"
    },
    {
      id: "air-filter-clean",
      name: "AIR FILTER CLEAN",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant filtres à air"
    },
    {
      id: "carbu-clean",
      name: "CARBU CLEAN",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant carburateur"
    },
    {
      id: "contact-cleaner",
      name: "CONTACT CLEANER",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant contacts électriques"
    },
    {
      id: "engine-flush",
      name: "ENGINE FLUSH",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Rinçage moteur avant vidange"
    },
    {
      id: "diesel-system-clean",
      name: "DIESEL SYSTEM CLEAN",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant système diesel"
    },
    {
      id: "fuel-system-clean",
      name: "FUEL SYSTEM CLEAN",
      image: "https://images.unsplash.com/photo-1558618047-3c8c76ca7d13?w=300&q=80",
      description: "Nettoyant système carburant"
    }
  ];
      ...
      <section className="relative bg-gray-800 text-white py-20 overflow-hidden">
        ...
        <div className="relative z-10 container mx-auto px-4">
          ...
          <p className="text-xl md:text-2xl text-gray-300 max-w-3xl">
            Produits d'entretien et maintenance haute performance pour préserver 
