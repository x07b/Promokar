...
<<<<<<< HEAD
import { ChevronLeft, ChevronRight, Wrench, Shield, Star, Zap, Award } from "lucide-react";
=======
...
<<<<<<< HEAD
          <div className="text-center">
            <div className="inline-flex items-center bg-[#BE941B]/20 border border-[#BE941B]/30 rounded-full px-8 py-3 mb-8">
              ...
              <span className="text-[#BE941B] font-bold text-sm uppercase tracking-widest">Gamme Entretien</span>
            </div>
            
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              <span className="block bg-gradient-to-r from-[#BE941B] to-white bg-clip-text text-transparent">Entretien</span>
            </h1>
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-black text-[#02173C] mb-6">
              Produits <span className="bg-gradient-to-r from-[#BE941B] to-[#02173C] bg-clip-text text-transparent">Entretien</span>
            </h2>
...
<<<<<<< HEAD
            {entretienProducts.map((product, index) => (
              <Link key={product.id} to={`/produits/entretien/${product.id}`} className="group cursor-pointer">
