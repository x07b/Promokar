...
import { ChevronLeft, ChevronRight, ArrowRight, Trophy, Car, Shield, Star, Zap, Award, Clock, MapPin, Check } from "lucide-react";

export default function CompetitionLineVehicules() {
  const competitionProducts = [
    {
      id: "dinoil-daytona-5w50",
      ...
      <section className="relative bg-gradient-to-br from-[#02173C] to-[#02173C]/90 text-white py-20 overflow-hidden">
        <div className="absolute inset-0">
          <img 
            ...
            alt="Competition Line Vehicules"
        ...
        <div className="relative z-10 container mx-auto px-6">
          ...
          <div className="text-center">
            ...
            <h1 className="text-5xl md:text-7xl font-black mb-6 leading-tight">
              <span className="block">Véhicules de</span>
            ...
            <p className="text-xl md:text-2xl text-gray-300 max-w-4xl mx-auto leading-relaxed">
              Lubrifiants haute performance conçus pour les véhicules de compétition.
              <br />
        ...
        <div className="container mx-auto px-6">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto leading-relaxed">
              Produits haute performance pour véhicules de compétition et sport automobile
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
            {competitionProducts.map((product, index) => (
              <Link key={product.id} to={`/produits/competition-line/vehicules/${product.id}`} className="group cursor-pointer">
              ...
              <div className="absolute -bottom-6 -right-6 bg-white rounded-2xl p-6 shadow-2xl border border-gray-100">
                <div className="text-center">
                  <div className="w-12 h-12 bg-[#BE941B]/10 rounded-xl flex items-center justify-center mx-auto mb-3">
                    <Trophy className="w-6 h-6 text-[#BE941B]" />
                  </div>
